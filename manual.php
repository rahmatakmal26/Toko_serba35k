...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #ff8680"><b>Cara Order</b></h2>
	<div class="bs-acc">
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="background-color: #eee;">
					<h4 class="panel-title">Bagaimana Cara Berbelanja baju di Toko Serba 35K ?</h4>
				</div>
				</a>
				<div id="collapseOne" class="panel-collapse collapse in">
					<div class="panel-body">
						<ol>
							...
							<li>Jika anda melakukan pembayaran online, sertakan bukti pembayaran pada saat konfirmasi pembayaran</li>
						</ol>
					</div>
				</div>
			</div>
