...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13,  at 11:04 AM
...
CREATE TABLE `produksi` (
  ...
  `etd_metode_pembayaran` varchar(200) NOT NULL,
...
INSERT INTO `produksi` (`id_order`, `invoice`, `kode_customer`, `kode_produk`, `nama_produk`, `qty`, `harga`, `ukuran`, `status`, `tanggal`, `provinsi`, `kota`, `alamat`, `kode_pos`, `metode_pembayaran`, `metode_pembayaran`, `ongkir`, `etd_metode_pembayaran`, `terima`, `tolak`, `cek`, `grand_total`, `timess`, `images`, `tgl`) VALUES
