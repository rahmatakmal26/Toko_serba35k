...
*/
$time = date('H:i:s');
$tanggal = date('d M Y H:i:s', strtotime('+1 hour'));
$t = date('Y-m-d');
...
while($row = mysqli_fetch_assoc($keranjang)){
	...
	$order = mysqli_query($conn, "INSERT INTO produksi VALUES('','$format','$kd_cs','$kd_produk','$nama_produk','$qty','$harga','$ukuran','$status','$tanggal','$prov','$kota','$alamat','$kopos','$metode_pembayaran','$paket','$ongkir','$etd','0','0','0','0','$time','','$t')");
